...
function viewContactUsDetails(event, elementId){

    itRequestDetailsList = document.getElementsByClassName("contact-us-details");
    ...
    itRequestList = document.getElementsByClassName("contact-us");
...
function viewSubdivisionDetails(event, elementId){

    apartmentOwnerDetailsList = document.getElementsByClassName("subdivision-manager-detail");
    console.log(apartmentOwnerDetailsList)
    ...
    apartmentList = document.getElementsByClassName("subdivision-manager-detail-tile");
    console.log(apartmentList)
