...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email_id`, `password`, `area_code`, `phone_number`, `joining_datetime`, `roles_id`) VALUES (NULL, 'Admin', 'Admin', 'admin@gmail.com', '00ba7ceab606427071d5d755ea99e976', '123', '1234562222', '2021-01-01 06:31:03', (select id from roles where role_name = 'admin'));
